...
run_guardrails_track() {
    ...
    case "$FIXTURE" in
        ...
        php-track-open-priority-guardrails)
            _guardrails_scan_prompt "Run one pass of the orchestrator against this repo: Track selection (skills/continuous-refactoring/SKILL.md step 1, skills/continuous-refactoring/references/track-scheduler.md) and then /refactor-scan with the selected Track (skills/refactor-scan/SKILL.md, skills/refactor-scan/references/guardrails-track.md, skills/refactor-scan/references/track-open-processing.md). Stop after scan's output — do not implement. Report, as your final line: WORKED phpmd (the Guardrails Open walk worked phpmd) or WORKED priority (the refactor:priority issue was worked instead)."
            local out="/tmp/guardrails-track-$FIXTURE-scan.log"
...
# skills/continuous-refactoring/SKILL.md step 1). Local-only, advisory,

...
never both. No MR to remember, no `Create-mode` bookkeeping to touch — land this via the dedicated
bookkeeping branch, then skip straight to *Then, regardless of which branch...* below.

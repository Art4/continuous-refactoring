...
- ~~`Fulfilled nodes`~~ — retired. No write needed; old files retain entries for historical record, ignored by all lifecycle skills (see `../continuous-refactoring/references/refactoring-bookkeeping.md`'s *`Fulfilled nodes`* section).

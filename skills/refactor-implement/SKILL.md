...
**Outlook, tooling-tree candidate only:** comment on the candidate issue with what this unlocks, never the MR description — `skills/refactor-implement/references/outlook-comment.md`.

...
Full definition (Fulfilment check, MR scope, Recommended parent, Recommended child): `skills/refactor-scan/references/php-tooling-tree/php-cs-fixer.md`.

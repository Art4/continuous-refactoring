...
**Blocked by:** 05 ✓ done — Make the orchestrator degrade gracefully, 06 ✓ done — Tooling tree (ADR-0005), 12 — Deliver each refactor as a merge request, skills updated to ADR-0005 (not yet ticketed)

...
| `refactor-design` | `/grilling` (Z.8,18) | core (design loop) | self-sufficient | 02 (planned) |
| `refactor-design` | `/domain-modeling` (Z.8,26) | enrichment (side effects) | crash-safe | 02 (planned) |
| `refactor-implement` | `/tdd` (Z.10) | core (red→green rules) | self-sufficient | 03 (planned) |
